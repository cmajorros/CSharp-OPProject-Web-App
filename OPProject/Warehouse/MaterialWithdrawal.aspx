<%@ Page Title="" Language="C#" MasterPageFile="~/OP.Master" AutoEventWireup="true" CodeBehind="MaterialWithdrawal.aspx.cs" Inherits="OPProject.Warehouse.MaterialWithdrawal" %>
            ...
            <td class="style11">
                <asp:Panel ID="Panel4" runat="server">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                                    ...
                                    <asp:ListItem>เบิกสินค้าครบแล้ว</asp:ListItem>
                                    <asp:ListItem>ยังเบิกสินค้ายังไม่ครบ</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                            <td>
                                &nbsp;</td>
                        ...
                        <tr>
                            <td>
                                จำนวนที่สามารถเบิกได้</td>
                            <td>
                                <asp:Label ID="lblRemainQty" runat="server" Text="Label"></asp:Label>
                                &nbsp;
                        ...
                        <tr>
                            <td>
                                จำนวนวัตถุดิบคงเหลือในการเบิกครั้งต่อไป&nbsp;&nbsp;&nbsp;
                            </td>
                            <td>
                                <asp:Label ID="lblNewRemain" runat="server" Text="Label"></asp:Label>
                                &nbsp;
